...
Consequently, researchers had to develop their simplified own solutions, with little or no dissemination to the community, limiting knowledge and expertise sharing.
...
They can use different heuristics: interior point methods (\ipopt, [\addref]) or sequential quadratic programming (\textit{snopt}, \acados [\addref]), but they are all gradient based.
