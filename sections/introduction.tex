...
The objective of the present paper is to introduce \bioptim\footnote{\url{https://github.com/pyomeca/bioptim}\\DOI: 10.5281/zenodo.4562883}, an \comment{open-source}{je l'ai corrigé quelques fois, mais ça semble revenir, open source ne prend pas de tiret} optimal control software dedicated to musculoskeletal biomechanics.
