...
The MHE was able to forecast the movement kinematics with a root mean square error of $1.3\pm0.5^{\circ}$ while provided a realistic estimation of muscle forces close to the ground truth with a root mean square error of $10.6\pm13.6N$ (Fig.~\ref{fig:MHE_results}). 