...
\caption{Time series of real-time estimated muscle forces (blue) and ground truth muscle forces (orange) of a cyclic motion (Ex.~\ref{ex:mhe}). Only four muscles with significative action on the two selected DoFs of Fig.~\ref{fig:joint_angles_MHE}) are shown.
