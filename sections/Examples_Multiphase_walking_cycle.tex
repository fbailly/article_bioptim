...
\caption{Snapshots of a walking gait cycle driven by muscles activation with histogram of muscle activations below. The red lines represent muscles lines of action and the blue points depict the tracked markers. The activation of the Gluteus Maximus is the mean of its three parts, the Iliopsoas is the mean between iliacus and psoas and the Hamstring is the mean activation of the Semimembranous, Semitendinous and Biceps Femoris. }
...
The transition from stance to swing (60 \% - 70 \%) was highly actuated by hip flexors (Iliopsoas and Rectus Femoris) and leg muscles (Gastocnemius Medialis and Tibialis Anterior).
