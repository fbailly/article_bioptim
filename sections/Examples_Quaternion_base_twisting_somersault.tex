...
\end{eqnarray}
\comment{with}{Je pense qu'il faut standadiser la nomenclature. Ici, on n'utilise pas les termes de bioptim, je pense qu'on devrait, mais je préfère la façon que c'est exprimé ici (avec un underbrace) et le weight qui est mis dans le paragraphe plutôt que directement dans l'équation} $\omega_1 = 1\times 10^{-6}$, T the duration of the movement and $\tau_{i}$ the torque control of the $i^{th}$ arm DoF.
