...
For instance, in example \ref{ex:mhe}, \comment{we showed the possibility of estimating muscle forces in real time using \acados on a standard laptop.}{Non sequitur?}
