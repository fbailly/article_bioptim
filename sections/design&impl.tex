...
\bioptim is the top layer of a succession of \comment{dependencies}{software? libraries? toolboxes?} (\biorbd: dynamics and MSK modeling; \casadi: automatic differentiation; \ipopt/\acados: optimization; \bioviz: visualization).
